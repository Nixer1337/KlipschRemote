...
class VSlider:
    ...
    def __init__(self, *, lo: int, hi: int, on_commit, height: int = 200,
        ...
        self.control = ft.GestureDetector(
            content=ft.Stack([self._track, self._fill, self._thumb],
                             width=width, height=height),
            on_tap_down=self._on_tap, on_pan_start=self._on_drag,
            on_pan_update=self._on_drag, on_pan_end=self._on_end,
        )
